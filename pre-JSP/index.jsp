...
<body>
    <header>
       ...
       <div class="header-person">
            <button type="button" class="explain new">版本说明</button>
            <div class="slide">
    ...
    <nav>
        <ul class="root">
            ...
            <ul class="children hide">
                ...
                <ul class="cascading">
                    <li data-permissions="M017003001,M017003" class="new"><a href="#coreOp/online">在线-概览</a></li>
                    <li data-permissions="M017003003" class="new"><a href="#coreOp/onlineTer">在线-分终端类型</a></li>
                    <li data-permissions="M017003002" class="new"><a href="#coreOp/onlineAppVer">在线-分移动端版本</a></li>
                </ul>
                <li data-permissions="M017009"><a href="#coreOp/MRR">MRR</a></li>
                <li data-permissions="M017004">
                    <a href="#coreOp/runaway">流失</a>
                </li>
                <li data-permissions="M017008" ><a href="#coreOp/CRM-user">CRM用户数</a></li>
                <li data-permissions="M017007" ><a href="#coreOp/actEntNum">活跃企业数</a></li>
            ...
            <ul class="children hide">
                ...
                <ul class="cascading">
                    <li data-permissions="M017056001"><a href="#coreBus/overviewUser">按用户</a></li>
                    <li data-permissions="M017056002"><a href="#coreBus/overviewEnt">按企业</a></li>
                </ul>
	...
	6555555555555555555555555555555555555555555555555555555
    </script>
</body>
